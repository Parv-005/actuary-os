-- 003_static_ensure.sql — repair/ensure for environments where 002 was
-- marked applied before its data section reached final form (env drift).
-- Fully idempotent (ON CONFLICT / WHERE NOT EXISTS): safe on fresh DBs.
